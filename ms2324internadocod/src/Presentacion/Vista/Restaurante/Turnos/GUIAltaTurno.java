...
public class GUIAltaTurno extends JFrame implements IGUI {
	...
	public void initGUI() {
		...
		aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if (Nombre.matches(".*\\d+.*") || Nombre.length() == 0)
					...
					TTurno t = new TTurno(-1, Nombre, Hora_Entrada, Hora_Salida, true);

					ApplicationController.getInstancia().handleRequest(new Context(Evento.AltaTurno, t));
		...
		this.setBounds(600, 600, 400, 175);
	...
	public void actualizar(Context context) {
		...
		if (context.getEvento() == Evento.AltaTurno_OK) {
