...
public class DesvincularPlatoProducto extends JFrame implements IGUI {

	private static final long serialVersionUID = 1L;
	JButton aceptar,cancelar;
	JPanel panelPrincipal;
	
	public DesvincularPlatoProducto() {
		super("DESVINCULAR PLATO A PRODUCTO");
		initGUI();
		...
		aceptar.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				try{					
					...
					ApplicationController.getInstancia().handleRequest(new Context(Evento.DesvincularPlatoProducto,tpp));
	...
	public void actualizar(Context context) {
		if(context.getEvento()==Evento.DesvincularPlatoProducto_OK)
