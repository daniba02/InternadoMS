package Presentacion.Vista.Academia.Matriculable.GUIListarMatriculablePorAsignatura;
...
public class GUIListarMatriculablePorAsignatura extends JFrame implements IGUI {
	...
	public GUIListarMatriculablePorAsignatura() {
		super("LISTAR MATRICULABLES POR ASIGNATURA");
		initGUI();
	...
	public void initGUI() {
		...
		aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					ApplicationController.getInstancia().handleRequest(new Context(Evento.ListarMatriculablesPorAsignatura,Integer.parseInt(tidasignatura.getText())));					
				} catch (Exception e1) {
	...
	if(context.getEvento()==Evento.ListarMatriculablesPorAsignatura_OK) {
		int it = 0;
