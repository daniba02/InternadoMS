package Presentacion.Vista.Academia.Matriculable.GUIListarMatriculablePorAnio;
...
public class GUIListarMatriculablePorAnio extends JFrame implements IGUI {
	...
	public GUIListarMatriculablePorAnio() {
		super("LISTAR MATRICULABLES POR ANIO");
		initGUI();
	...
	public void initGUI() {
		...
		JLabel idanio = new JLabel(" ID anio: ");
		...
		panel3_2.add(idanio,BorderLayout.PAGE_START);
		panel3_1.add(tidanio,BorderLayout.PAGE_START);
		...
		aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
				ApplicationController.getInstancia().handleRequest(new Context(Evento.ListarMatriculablesPorAnio,Integer.parseInt(tidanio.getText())));
				} catch (Exception e1) {
	...
	if(context.getEvento()==Evento.ListarMatriculablesPorAnio_OK) {
		int it = 0;
