package Presentacion.Vista.Academia.Matriculable.GUIListarMatriculablePorGrupo;
...
public class GUIListarMatriculablePorGrupo extends JFrame implements IGUI {
	...
	public GUIListarMatriculablePorGrupo() {
		super("LISTAR MATRICULABLES POR GRUPO");
		initGUI();
	...
	public void initGUI() {
		...
		panel3_2.add(idGrupo,BorderLayout.PAGE_START);
		panel3_1.add(tidGrupo,BorderLayout.PAGE_START);
		...
		aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					ApplicationController.getInstancia().handleRequest(new Context(Evento.ListarMatriculablePorGrupo,Integer.parseInt(tidGrupo.getText())));					
				} catch (Exception e1) {
	...
	if(context.getEvento()==Evento.ListarMatriculablePorGrupo_OK) {
		int it = 0;
