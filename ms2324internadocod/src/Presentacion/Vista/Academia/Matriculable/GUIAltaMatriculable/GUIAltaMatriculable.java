package Presentacion.Vista.Academia.Matriculable.GUIAltaMatriculable;
...
public class GUIAltaMatriculable extends JFrame implements IGUI {
	...
	public GUIAltaMatriculable() {
		super("ALTA MATRICULABLE");
		initGUI();
		...
		aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					ApplicationController.getInstancia().handleRequest(new Context(Evento.AltaMatriculable, m));
	...
	if(context.getEvento()==Evento.AltaMatriculable_OK) {
