package Presentacion.Vista.Academia.Matricula.GUIDesvincularMatriculaMatriculable;
...
public class GUIDesvincularMatriculaMatriculable extends JFrame implements IGUI {
...
private static final long serialVersionUID = 1L;
	...
	public GUIDesvincularMatriculaMatriculable() {
		super("DESVINCULAR MATRICULA DE MATRICULABLE");
		initGUI();
	...
	public void initGUI() {
		...
		aceptar.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				try{					
					...
					ApplicationController.getInstancia().handleRequest(new Context(Evento.DesvincularMatriculaMatriculable,tmm));
		...
		this.setBounds(350,350,650,120);
	...
	public void actualizar(Context context) {
		if(context.getEvento()==Evento.DesvincularMatriculaMatriculable_OK)
