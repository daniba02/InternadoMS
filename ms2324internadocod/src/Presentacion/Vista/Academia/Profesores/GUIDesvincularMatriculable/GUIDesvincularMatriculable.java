package Presentacion.Vista.Academia.Profesores.GUIDesvincularMatriculable;
...
public class GUIDesvincularMatriculable extends JFrame implements IGUI{
...
this.setResizable(false);
		...
		aceptar.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				try{					
					...
					}catch(Exception ex2){throw new Exception("El ID de profesor debe ser un numero");}
					try{
					...
					if(idProfesor<=0 || idmatriculable <=0) throw new Exception("El id debe ser mayor que 0");
					
					TProfesorMatriculable tmm = new TProfesorMatriculable(idProfesor,idmatriculable);
					
					ApplicationController.getInstancia().handleRequest(new Context(Evento.DesvincularProfesorMatriculable,tmm));
	...
	public GUIDesvincularMatriculable() {
		super("DESVINCULAR PROFESOR A MATRICULABLE");
		initGUI();
	...
	public void actualizar(Context context) {
		if(context.getEvento()==Evento.DesvincularProfesorMatriculable_OK) {
